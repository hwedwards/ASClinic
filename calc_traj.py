...
def main():
    ...
    segments = [
        ...
        ([3600, -1600, 4400, -2400], [0, 0, 0, 0], 8), #4
        ([4400, -2400, 5000, -3800], [0, 0, 0, 0], 10), #5
        ([5000, -3800, 6600, -2000], [0, 0, 0, 0], 13), #6
        ([6600, -2000, 7600, 500], [0, 0, 0, 0], 13), #6.5
        ([7600, 500, 7600, 1100], [0, 0, 0, 0], 6), #7
        ([7600, 1100, 6000, 500], [0, 0, 0, 0], 10), #8
        ([6000, 500, 5000, 200], [0, 0, 0, 0], 8), # 9
        ([5000, 200, 4000, 1400], [0, 0, 0, 0], 9), # 10
        ([4000, 1400, 4200, 3400], [0, 0, 0, 0], 12), # 11
        ([4200, 3400, 5000, 4800], [0, 0, 0, 0], 10), #12
        ([5000, 4800, 600, 4600], [0, 0, 0, 0], 24), #13
        ([600, 4600, 0, 3200], [0, 0, 0, 0], 10), #14
        ([0, 3200, -1200, 500], [0, 0, 0, 0], 16), #15
        ([-1200, 500, 0, 0 ], [0, 0, 0, 0], 9) #16
    ]
    phi_list = []
    coeffx_list = []
    coeffy_list = []
