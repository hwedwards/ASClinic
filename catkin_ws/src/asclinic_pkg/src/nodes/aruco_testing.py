...
# TO DO: 
# - TEST YAW ANGLE VARIATION AT DIFFERENT DISTANCES.
# - TEST VARIATION WITH ANGULAR MOTION.
# - TEST VARIATION WITH LINEAR MOTION.
def get_true_position(position_id):
    true_positions = {
        1: {'front': [0, 0, 1], 'yaw': 180},
        2: {'front': [-0.5, 0, 1], 'yaw': 180},
        3: {'front': [0.5, 0, 1], 'yaw': 180},
        4: {'front': [0, 0, 2], 'yaw': 180},
        5: {'front': [-0.5, 0, 2], 'yaw': 180},
        6: {'front': [0.5, 0, 2], 'yaw': 180},
        7: {'front': [0, 0, 3], 'yaw': 180},
        8: {'front': [-0.5, 0, 3], 'yaw': 180},
        9: {'front': [0.5, 0, 3], 'yaw': 180},
        10: {'front': [0, 0, 4], 'yaw': 180},
        11: {'front': [-0.5, 0, 4], 'yaw': 180},
        12: {'front': [0.5, 0, 4], 'yaw': 180},
        13: {'front': [0, 0, 7], 'yaw': 180},
        14: {'front': [0.8, 0, 7], 'yaw': 180},
        15: {'front': [-0.8, 0, 7], 'yaw': 180},
        16: {'front': [0, 0, 10], 'yaw': 180},
        17: {'front': [1.2, 0, 10], 'yaw': 180},
        18: {'front': [-1, 0, 10], 'yaw': 180},
        19: {'front': [0, 0, 14], 'yaw': 180},
    }
    return true_positions.get(position_id, None)

# Set the current position id for this stationary test
CURRENT_POSITION_ID = 19
...
def save_data():
    ...
    fieldnames = ['timestamp', 'position_id', 'marker_id', 'camera_x', 'camera_y', 'camera_z',
                    'yaw_deg', 'front_x', 'front_y', 'front_z']
